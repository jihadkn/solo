...
import (
	...
	"github.com/jihadkn/etc-core-solo/api"
	"github.com/jihadkn/etc-core-solo/payouts"
	"github.com/jihadkn/etc-core-solo/proxy"
...
func main() {
	...
	if cfg.Threads > 0 {
		...
		color.Cyan("Running with %v threads", cfg.Threads)
	}
